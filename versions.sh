...
versions=(
     ...
     ["6.0.0"]=main*5.6.40*mariadb-server-10.1*vtigerCRM*vtiger%20CRM%206.0.0/Core%20Product/vtigercrm6.0.0.tar.gz
     ["6.0.0-RC"]=main*5.6.40*mariadb-server-10.1*vtigerCRM*vtiger%20CRM%206.0%20RC/Core%20Product/vtigercrm-6.0.0rc.tar.gz
     ["6.0.0-Beta"]=main*5.6.40*mariadb-server-10.1*vtigerCRM*vtiger%20CRM%206.0%20Beta/Core%20Product/vtigercrm-6.0Beta.tar.gz
