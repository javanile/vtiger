...
declare -A versions
versions=(
     ["7.1.0"]=main*7.2.22*vtiger%20CRM%207.1.0/Core%20Product/vtigercrm7.1.0.tar.gz
     ["7.1.0-RC"]=main*7.2.22*vtiger%20CRM%207.1.0%20RC/Core%20Product/vtigercrm7.1.0rc.tar.gz
     ["7.0.1"]=main*7.2.22*vtiger%20CRM%207.0.1/Core%20Product/vtigercrm7.0.1.tar.gz
     ["7.0.0"]=main*7.2.22*vtiger%20CRM%207.0/Core%20Product/vtigercrm7.0.0.tar.gz
