...
RUN apt-get update && \
    ...
    cd /usr/src/vtiger && \
    curl -o vtiger.tar.gz -L "http://sourceforge.net/projects/vtigercrm/files/Vtiger%20CRM%206.1.0%20Beta/Core%20Product/vtigercrm-6.1.0-ea.tar.gz" && \
